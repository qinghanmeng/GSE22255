...
/* Calls modules :	error						*/
/************************************************************************/
int *allocate_ivector(int nl, int nh)
{
  int *v;
  
  v=(int *)malloc((unsigned)(nh-nl+1)*sizeof(int));
  if (v==NULL) error("Allocate_Ivector : Memory allocation failure.");
  return(v-nl);
}

/************************************************************************/
/* Module name : allocate_vector							*/
...
float *allocate_vector(int nl, int nh)
{
  ...
  if (v==NULL) error("Allocate_Vector : Memory allocation failure.");
  return (v-nl);
}

/************************************************************************/
/* Module name : allocate_dvector						*/
...
/* Calls modules :	error						*/
/************************************************************************/
double *allocate_dvector(int nl, int nh)
{
  double *v;
  
  v=(double *)malloc((unsigned)(nh-nl+1)*sizeof(double));
  if (v==NULL) error("Allocate_Dvector : Memory allocation failure.");
  return (v-nl);
}
